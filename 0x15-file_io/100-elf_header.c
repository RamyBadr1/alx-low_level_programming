...
/**
 * _close - close a file and print an erro
 * @fd: the file
 */
void _close(int fd)
{
...
/**
 * _read - read from a file, print an error message upon failure
 * @fd: the file
 * @buf: the buffer
